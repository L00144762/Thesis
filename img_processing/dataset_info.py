...
images = np.load('C:/Users/rcurran.GARTANTECH/PycharmProjects/Thesis/np_data/images.npy', allow_pickle=True)
labels = np.load('C:/Users/rcurran.GARTANTECH/PycharmProjects/Thesis/np_data/labels.npy' , allow_pickle=True)
#files = np.load('C:/Users/rcurran.GARTANTECH/PycharmProjects/Thesis/np_data/files.npy')
clss = np.load('C:/Users/rcurran.GARTANTECH/PycharmProjects/Thesis/np_data/clss.npy')
