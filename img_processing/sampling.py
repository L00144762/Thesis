...
from img_processing.practice_1 import CNN_NET, CNN_NET_3layers
...
data, labels, files = shuffle(data, labels, files, random_state = 24)
...
trainX, testX, trainY, testY = train_test_split(data, labels, test_size= 0.25, random_state= 5670)
...
# talk about padding and why it's set to same as I wan